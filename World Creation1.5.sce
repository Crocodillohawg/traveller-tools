...
elseif atmo<=3 & atmo>=2 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-2
elseif atmo<=5 & atmo>=4 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-1
elseif atmo==14 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-1
elseif atmo>=6 & atmo<=7 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)
elseif atmo>=8 & atmo<=9 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)+1
elseif atmo==10 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)+2
elseif atmo==13 then
...
elseif atmo==15 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)+2
elseif atmo>=11 & atmo<=12 then
    temp=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)+6
end
if temp<0 then
    temp=0
end
...
elseif atmo<=1 | atmo>=10 then
    if temp<=11 & temp>=10 then
        hydro=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-13
    elseif temp>=12 then
        hydro=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-17
    else
        hydro=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-11
    end
else 
    if temp<=11 & temp>=10 then
        hydro=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-9+atmo
    elseif temp>=12 then
        hydro=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-13+atmo
    else
        hydro=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)-7+atmo
end
end
if hydro<0 then
    hydro=0
...
if pop<10 & pop>7 then
    star=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)+1
elseif pop>=10 then
    star=grand(1,1,"uin",1,6)+grand(1,1,"uin",1,6)+2
